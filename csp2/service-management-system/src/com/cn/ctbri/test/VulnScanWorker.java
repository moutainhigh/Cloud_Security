...
public class VulnScanWorker {
	 ...
	 * 创建漏洞扫描订单（任务）
	 */
	private static String VulnScan_Create_Order = "rest/openapi/vulnscan/order";
	/**
	 * 对漏洞扫描订单进行操作，暂停，重启，停止
	 */
	private static String VulnScan_Opt_Order = "rest/openapi/vulnscan/order/";
	/**
	 * 获得订单检测结果报告
	 */
	private static String VulnScan_Get_OrderReport = "rest/openapi/vulnscan/orderReport/";
	/**
	 * 获得订单/任务检测结果
	 */
	private static String VulnScan_Get_OrderResult = "rest/openapi/vulnscan/orderResult/";
	/**
	 * 获得订单/任务当前执行状态
	 */
	private static String VulnScan_Get_OrderStatus = "rest/openapi/vulnscan/orderStatus/";
	
	public VulnScanWorker() {
	}
...
//        String create = vulnScanCreate("2", new String[]{"http://www.testfire.net"}, "", "2016-02-16 17:55:35", "", "", "", "", "", new String[]{"2"});
...
//    	String result = vulnScanGetResult("16021615033414544","1");
    	String report = vulnScanGetReport("16021916432586375");
