...
public class AdminWarningController {
    ...
    @RequestMapping(value="adminwarningInit.html")
...
//        User user = (User)request.getSession().getAttribute("globle_user");
        ...
        String id = orderService.getOrderById(orderId, type, o.getUserId());
...
//        	return "/source/error/errorMsg";
	...
	//            }
	            ...
	            if(serviceId==6||serviceId==7||serviceId==8){//DDOS
	                ...
	                return "/source/adminPage/orderManage/order_warning";
	    			...
	    			case 3:/**篡改  dyy*/
	            		...
	            		return "/source/adminPage/orderManage/warning_doctort"	;
	    			case 4:/**关键字监测服务 dyy*/    				
	                	...
	                	return "/source/adminPage/orderManage/warning_keyword"	;
	    			case 5:/**可用性监测服务 dyy*/
	    				//可用性  折线图 左侧信息
	    			    ...
	    			    return "/source/adminPage/orderManage/order_usable";
	    			default: //漏洞和木马
	    	            request.setAttribute("alarmList", alarmList);
	    	            return "/source/adminPage/orderManage/warning";
	    			}
	            }
	        }
	 ...
	 *		 @time 2015-3-9
	 */
	@RequestMapping(value="admingetData.html" ,method = RequestMethod.POST)
	@ResponseBody
     ...
     *       @time 2015-3-9
     */
    @RequestMapping(value="admingetDataUsable.html" ,method = RequestMethod.POST)
    @ResponseBody
...
//                	}
     ...
     *     @time 2015-4-10
     */
    @RequestMapping(value="admingetExecuteTime.html")
    @ResponseBody
...
//        	String str = DateUtils.dateToString(t.getExecute_time());
     ...
     *     @time 2015-2-3
     */
    @RequestMapping(value="admingetGaugeData.html")
    @ResponseBody
     ...
     *     @time 2015-2-3
     */
    @RequestMapping(value="admingetPieData.html")
    @ResponseBody
     ...
     *     @time 2015-7-23
     */
    @RequestMapping(value="admingetBarData.html",method = RequestMethod.POST)
    @ResponseBody
...
//        return json.toString();
     ...
     *     @time 2015-2-3
     */
    @RequestMapping(value="admingetLineData.html")
    @ResponseBody
...
//            List<Alarm> highList = alarmService.getAlarmByTaskId(param);
     ...
     *     @time 2015-2-2
     */
    @RequestMapping(value="adminorderDetails.html")
    public String orderDetails(HttpServletRequest request){
        ...
        return "/source/adminPage/orderManage/orderDetail";
    }
     ...
     *     dyy
     */
    @RequestMapping(value="adminhistoryInit.html")
...
//        paramMap.put("type", type);
        ...
        if(serviceId==6||serviceId==7||serviceId==8){//DDOS
        	...
        	request.setAttribute("serviceId", serviceId);
            request.setAttribute("alarmList", alarmDDosList);
            return "/source/adminPage/orderManage/history_waring";
     ...
     * 		@time 2015-4-8
     */
    @RequestMapping(value="/adminscaning.html")
    @ResponseBody
...
//        	    m.put("currentUrl", "无");
     ...
     * 		@time 2015-4-8
     */
    @RequestMapping(value="/admingetAssetName.html")
    @ResponseBody
     ...
     * 功能描述：告警2扫描中状态
     */   
    @RequestMapping(value="adminwarningTask.html")
     ...
     * 功能描述：敏感词
     */   
    @RequestMapping(value="adminkeyWord.html" ,method = RequestMethod.POST)
     ...
     * 功能描述：详情
     */   
    @RequestMapping(value="admindetails.html" ,method = RequestMethod.POST)
     ...
     * 		@time 2015-4-8
     */   
    @RequestMapping(value="adminwarningTwoInit.html")
...
//                //本次已完成
//            }
        	return "/source/adminPage/orderManage/warningtwo";
        }
    }
    /**
     * 功能描述：结果报表页--安恒 
     ...
     * 		@time 2015-4-14
     */
    @RequestMapping(value="adminwarningTwoAnHeng.html")
