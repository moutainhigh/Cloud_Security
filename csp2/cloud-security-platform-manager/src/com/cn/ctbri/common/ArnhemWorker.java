...
//        String url = SERVER_WEB_ROOT + "/rest/task/getTaskProgress";
     ...
     * @return 任务状态代码
     */
    public static String getEngineState(String sessionId, int engine) {
        //创建路径
        String url = "";
        if(engine==1){
	   		// 创建路径
	   		url = SERVER_WEB_ROOT1 + "/rest/control/GetEngineState"; 
	   	}else{
	   		url = SERVER_WEB_ROOT2 + "/rest/control/GetEngineState";
	   	}  
        //创建配置
        ClientConfig config = new DefaultClientConfig();
        //绑定配置
...
//        String sessionId1 = getSessionId("https://219.141.189.187:60443","developer","developer111111");
        String s1 = getEngineState(sessionId,2);
