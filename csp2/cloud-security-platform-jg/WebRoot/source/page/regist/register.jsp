  ...
  <div id="close_edit"></div>  <div class="text_1">
    ...
    <div class="text_top" style="text-align:center;">安全帮用户协议</div>
      <div id="f1" class="dd" style="overflow:auto;height:430px;width:870px;margin-top:15px;">
        ...
        <p class="help_detail">1.1 安全帮是电信北研院为用户提供云安全服务的平台，所提供的服务包括但不限于：网站安全服务、系统安全服务、数据库安全服务、安全态势分析、安全大数据分析。</p>
        <h3 class="helph">2. 服务规则</h4>
        <p class="help_detail">2.1 用户在使用安全帮时，必须遵守中华人民共和国相关法律法规的规定；</p>
        <p class="help_detail">2.2 用户应明确在使用安全帮服务过程中提交到平台的所有网络、计算机及个人信息都为其所有或已得到信息原始所有者的授权，并且明确同意授权安全帮在提供云安全服务过程中使用这些信息；</p>
        <p class="help_detail">2.3 用户应同意将不会利用本平台进行任何违法或不正当的活动，包括但不限于下列行为∶</p>
           ...
           <p class="help_detail"> &nbsp;  2） 未经允许，对计算机信息网络功能进行删除、修改或者增加的；</p> 
            <p class="help_detail"> &nbsp; 3） 未经允许，对进入计算机信息网络中存储、处理或者传输的数据和应用程序进行删除、修改或者增加的；</p> 
             ...
             <p class="help_detail"> &nbsp; 5） 其他危害计算机信息网络安全的行为。</p> 
              <p class="help_detail">2.4 用户违反本协议或相关的服务条款的规定，导致或产生的任何第三方主张的任何索赔、要求或损失，包括合理的律师费，您同意赔偿电信北研院与合作公司、关联公司，并使之免受损害。对此，电信北研院有权视用户的行为性质，采取包括但不限于删除用户发布信息内容、暂停使用许可、终止服务、限制使用、回收帐号、追究法律责任等措施。对恶意注册安全帮帐号或利用安全帮帐号进行违法活动、捣乱、骚扰、欺骗、其他用户以及其他违反本协议的行为，安全帮有权回收其帐号。同时，电信北研院会视司法部门的要求，协助调查。</p>
        <p class="help_detail">2.5 用户不得对安全帮服务任何部分或全部服务之使用或获得，进行出售、转售或用于任何其它商业目的。</p>
         <p class="help_detail">2.6 用户须对自己在使用安全帮过程中的行为承担法律责任。用户承担法律责任的形式包括但不限于：对受到侵害者进行赔偿，以及在电信北研院首先承担了因用户行为导致的行政处罚或侵权损害赔偿责任后，用户应给予电信北研院等额的赔偿。</p>
