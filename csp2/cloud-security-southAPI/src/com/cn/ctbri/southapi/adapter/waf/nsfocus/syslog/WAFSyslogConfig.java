...
public class WAFSyslogConfig {
	...
	public static final String DEFAULT_PACKET_DISPOSEMODE = "Store";
	...
	public static String packetDisposeMode = DEFAULT_PACKET_DISPOSEMODE;
	...
	static {
		...
		try {
			FileInputStream fis = new FileInputStream(syslogConfigFile);//属性文件流      
			prop.load(fis);//
