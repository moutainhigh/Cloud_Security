...
public interface TWafLogWebsecMapper {
    ...
    @Insert({
        ...
        "#{siteId,jdbcType=INTEGER}, #{protectId,jdbcType=INTEGER}, ",
        ...
        "#{policyId,jdbcType=INTEGER}, #{ruleId,jdbcType=INTEGER}, ",
        ...
        "#{characters,jdbcType=VARCHAR}, #{countNum,jdbcType=INTEGER}, ",
    ...
    @Results({
        ...
        @Result(column="protect_id", property="protectId", jdbcType=JdbcType.INTEGER),
