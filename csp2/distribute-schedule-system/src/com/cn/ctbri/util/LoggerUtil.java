...
public class LoggerUtil {
	 ...
	 * @param logMessage 消息
	 */
	public static Logger addLoginfo(String loginId, String userName, Date logTime, String optClass, String optMethod, String logLevel, String logMessage) {
		Logger logInf=new Logger();
