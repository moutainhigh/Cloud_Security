		...
		<div class="rides-cs" style="position:absolute;z-index:10;">
			...
			<div class="floatL" id="urlLeft">
				<a style="display:block" id="aFloatTools_Show" class="btnOpen"
					title="" href="javascript:void(0);">展开</a> <a style="display:none"
	...
	<script>
		...
		function dsb() {
			...
			if (x < 13) {
				...
				tbody.innerHTML = "<tr class='second-level'><th class='th-title col-service one'>编号</th><th class='col-border'></th><th class='th-title col-attacker-ip two'>URL</th><th class='col-border'></th><th class='th-title col-attacker-ip three'>IP</th><th class='col-border'></th><th class='th-title col-attacked-ip four'>国家</th><th class='col-border'></th><th class='th-title col-service five'>地区</th></tr>";
				for (var i = 0; i < 8; i++) {
									...
									.ajax({
										...
										success : function(data) {
											...
											option = {
												...
												tooltip : {
													trigger : 'item',
													formatter : function(params) {//提示框内容
