    ...
    <div class="login_form">
      <form  id="form_login" name="form_login" action="${ctx}/login.html" method="post">
        <div class="login_list">
          ...
          <input type="text" class="login_txt required" id="login_name" name="name" autocomplete="off"/>
        ...
        <div class="login_list">
          ...
          <input type="password" class="login_txt login_pass" id="login_password" name="password" onfocus="this.type='password'" autocomplete="off"/>
      ...
      <form  id="form_regist" action="${ctx}/registToLogin.html" name="form_regist" method="post">
        <table>
          ...
          <tr class="register_tr">
            ...
            <td class="regist_input"><input type="password" class="regist_txt required" name="password" id="regist_password" onblur="checkPassword()" autocomplete="off"/><span id="regist_password_msg" style="color:red;float:left"></td>
