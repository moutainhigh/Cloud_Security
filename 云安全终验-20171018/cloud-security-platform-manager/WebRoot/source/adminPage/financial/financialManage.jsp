	...
	<div class="main_center">
        ...
        <div class="system_table" id="div" style="display:block;height:300px;">
             <div style="height:30px;font-size:16px;">当天订单交易额总数 : <span style="font-size:14px;">${orderAmount}</span></div>
        	   <table cellpadding="0" cellspacing="0" id="table" style="width:50%;">
            	<thead>
                    <tr height="40">
                    	<th style="display: none;"></th>
                        <th width="250" >服务名</th>
                        <th width="136" >订单交易总额</th>
                     </tr>
                </thead>
                <tbody id="tbody">
                   <c:forEach items="${serviceAmountList}" var="order">
                       <tr>
                          ...
                          <td  width="250" style="text-align:center">${order.servName }</td>
                          <td  width="336" style="text-align:center">${order.price }</td>
                       </tr>
                   </c:forEach>
                </tbody>
            </table>
                ...
                <div  class="fr order" id="tradingCurve" style="left:500px;bottom:140px;width:530px;height:400px;overflow:auto"></div> 
            </div>
        </div>
