...
public class OrderAssetMapper implements RowMapper {
	...
	public Object mapRow(ResultSet rs, int num) throws SQLException {
		...
		orderAsset.setIpArray(rs.getString("ipArray"));
		orderAsset.setSermonth(rs.getInt("sermonth"));
		orderAsset.setTargetKey(rs.getString("targetKey"));
		orderAsset.setAssetAddr(rs.getString("assetAddr"));
		orderAsset.setAssetName(rs.getString("assetName"));
		orderAsset.setDomainIp(rs.getString("domainIp"));
		return orderAsset;
	}
