...
public class SelfHelpOrderServiceImpl implements ISelfHelpOrderService{
   ...
   //删除联系人
	...
	public void delServ(String serviceId,String parent) {
		if(parent.equals("6")){
			selfHelpOrderDao.delServAPI(serviceId);
		}else{
			
			selfHelpOrderDao.delServ(serviceId);
		}
	...
	public int findWafPageNum() {
		// TODO Auto-generated method stub
		return selfHelpOrderDao.findWafPageNum();
	}
