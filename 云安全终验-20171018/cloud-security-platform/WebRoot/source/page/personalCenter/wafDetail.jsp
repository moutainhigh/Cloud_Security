	...
	<div class="safeBox">
       ...
       <div class="data_box">
        <div class="data_nav">
          ...
          <ul>
            <li><a href="${ctx}/warningWaf.html?orderId=${order.id }" title="" style="color: #2499fb;">实时数据</a></li>
            <li style="background-color: #f3f3f3;border-bottom: 1px solid #a6a6a6;"><a href="${ctx}/warningWaf.html?orderId=${order.id }&isHis=1&type=month&beginDate=<%=str_date %>" title="" style="color: #343434;">历史数据</a></li>
