...
//        String textEntity = response.getEntity(String.class);
	...
	public static String getWafAlertLevelCountInTime(String startDate, String endDate, String timeUnit, List<String> dstIpList){
		...
		json.put("timeUnit", timeUnit);
		json.put("dstIp", dstIpList);
    	String url = SERVER_WAF_ROOT + "/rest/adapter/getWafAlertLevelCountInTime";
    	//创建jersery客户端配置对象
	    ClientConfig config = new DefaultClientConfig();
	    //检查安全传输协议设置
	    buildConfig(url,config);
	...
	public static String getEventTypeCountInTime(String startDate, String endDate, String timeUnit, List<String> dstIpList) {
		...
		json.put("timeUnit", timeUnit);
		json.put("dstIp", dstIpList);
    	String url = SERVER_WAF_ROOT + "/rest/adapter/getEventTypeCountInTime";
    	//创建jersery客户端配置对象
	    ClientConfig config = new DefaultClientConfig();
	    //检查安全传输协议设置
	    buildConfig(url,config);
	...
	public static String getWafLogWebSecTimeCount(String startDate,String endDate, String timeUnit, List<String> dstIpList) {
		...
		json.put("timeUnit", timeUnit);
		json.put("dstIp", dstIpList);
    	String url = SERVER_WAF_ROOT + "/rest/adapter/getWafLogWebSecTimeCount";
    	//创建jersery客户端配置对象
	    ClientConfig config = new DefaultClientConfig();
	    //检查安全传输协议设置
	    buildConfig(url,config);
	...
	public static String getWafLogWebsecSrcIpCountInTime(String startDate,
			String endDate, String timeUnit, List<String> dstIpList, int limit) {
		//组织发送内容JSON
				JSONObject json = new JSONObject();
				json.put("startDate", startDate);
				json.put("endDate", endDate);
		    	...
		    	String url = SERVER_WAF_ROOT + "/rest/adapter/getWafLogWebsecSrcIpCountInTime";
		    	//创建jersery客户端配置对象
			    ClientConfig config = new DefaultClientConfig();
			    //检查安全传输协议设置
			    buildConfig(url,config);
