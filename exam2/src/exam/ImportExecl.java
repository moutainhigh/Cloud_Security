...
public class ImportExecl {
    ...
    private static void getNameValue(String name,int nameColumn,boolean isNameMarked,String value,int valueColumn,boolean isValueMarked,String filePath){
    ...
    private static void getTopNameValue(String name,int nameColumn,boolean isNameMarked,String value,int valueColumn,boolean isValueMarked,String filePath,int topNum){
    	ImportExecl poi = new ImportExecl();
        // List<List<String>> list = poi.read("d:/aaa.xls");
        List<List<String>> list = poi.read(filePath);
//        StringBuffer typeBuffer = new StringBuffer("var event_name = [");
//        StringBuffer countBuffer = new StringBuffer("var event_data = [");
        StringBuffer typeBuffer = new StringBuffer("var "+name+" = [");
        StringBuffer countBuffer = new StringBuffer("var "+value+" = [");
        if (list != null) {
        	int size = list.size();
    ...
    public static void main(String[] args) {
		getNameValue("area_name", 1, true, "area_data", 2, false, "/Users/shaozhenya/Desktop/area.xlsx");
		getTopNameValue("area_name", 1, true, "area_data", 2, false, "/Users/shaozhenya/Desktop/area.xlsx",10);
	}
