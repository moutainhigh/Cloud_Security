...
$(function(){	
    ...
    require(
        ...
        function (ec) {//回调函数
            ...
            //后台获取数据
            $.ajax({
            	url:"admingetGaugeData.html?orderId="+$('#orderId').val()+"&type="+$('#type').val()+"&group_flag="+$('#group_flag').val()+"&websoc="+$('#websoc').val(),
                dataType:"json",
...
//                    },2000)
    ...
    require(
        ...
        function (ec) {//回调函数
            ...
            $.ajax({
            	type : "post",
            	url:"admingetPieData.html?orderId="+$('#orderId').val()+"&type="+$('#type').val()+"&group_flag="+$('#group_flag').val()+"&websoc="+$('#websoc').val(),
                dataType:"json",
    ...
    require(
        ...
        function (ec) {//回调函数
          ...
          //后台获取数据
            $.ajax({
            	type : "post",
            	url:"admingetLineData.html?orderId="+$('#orderId').val()+"&type="+$('#type').val()+"&group_flag="+$('#group_flag').val()+"&websoc="+$('#websoc').val(),
                dataType:"json",
                contentType: "application/x-www-form-urlencoded; charset=utf-8",
                success:function(data){
                    $.each(data,function(i,p){
    ...
    require(
        ...
        function (ec) {//回调函数
          ...
          //后台获取数据
            $.ajax({
            	type: "post",
            	url:"admingetBarData.html?orderId="+$('#orderId').val()+"&type="+$('#type').val()+"&group_flag="+$('#group_flag').val()+"&websoc="+$('#websoc').val(),
                dataType:"json",
                contentType: "application/x-www-form-urlencoded; charset=utf-8",
                success:function(data){
                    $.each(data,function(i,p){
