...
public class DiskUsage {
	...
	public static List<SysDisk> getDiskUsage(HttpServletRequest request){
        ...
        for (File file : roots) {   
        	...
        	//获取当前盘符下空闲未使用大小
        	sd.setFreeSpace(file.getFreeSpace());
        	//已经使用 
        	sd.setUsableSpace(file.getUsableSpace());
        	//总容量
        	sd.setTotalSpace(file.getTotalSpace());
        	list.add(sd);
