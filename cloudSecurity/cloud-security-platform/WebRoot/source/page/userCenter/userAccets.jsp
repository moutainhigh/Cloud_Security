...
<div class="user_center clear">
  <div class="user_left">
    <ul class="user_1">
      ...
      <li class="active"><a href="${ctx}/userAccetsUI.html">我的资产</a></li>
      <h2>订购中心</h2>
  ...
  <div class="text_1">
    ...
    <div class="text_bottm">
      <table>
        <tr>
          <td style="width:20%;">资产名称</td>
          <td style="width:45%;"><input class="boz_inout_1" type="text" /></td>
        ...
        <tr>
          <td>资产地址</td>
          <td><input class="boz_inout_1" type="text" /></td>
          <td style="color:#e32929;"">资产IP重复，该资产已添加过！</td>
        </tr>
      </table>
    </div>
    <div style="margin-top:35px;"><a href="###"><img src="${ctx}/source/images/user_submit_3.jpg" /></a></div>
  </div>
</div>
<div id="box_logoIn2">
<div  id="close2"></div>
