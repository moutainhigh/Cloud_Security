           ...
           <tr>
             ...
             <td>
                ...
                <c:if test="${list.serviceId==6||list.serviceId==7||list.serviceId==8}">
                  	<c:if test="${list.begin_date<=temp&&list.status==0}"><a href="${ctx}/warningTwoAnHeng.html?orderId=${list.id }&type=${list.type}" target="_blank"><img src="${ctx}/source/images/status_4.jpg" title="服务中"/></a></c:if>
                </c:if>
                <!-- 华为的服务 -->
