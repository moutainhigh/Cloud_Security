...
<a href="<c:url value='/asserAddr.html'/>">首页</a>
<c:if test="${pb.pageCode > 1 }">
<a href="<c:url value='/asserAddr.html?pageCode=${pb.pageCode-1 }'/>">上一页</a>
</c:if>
...
<c:forEach begin="${begin }" end="${end }" var="i">
  <c:choose>
  	...
  	<c:otherwise>
  		<a href="<c:url value='/asserAddr.html?pageCode=${i}'/>">[${i}]</a>
  	</c:otherwise>
  </c:choose>
</c:forEach>
...
<a href="<c:url value='/asserAddr.html?pageCode=${pb.pageCode+1 }'/>">下一页</a>
</c:if>
<a href="<c:url value='/asserAddr.html?pageCode=${pb.totalPage }'/>">尾页</a>
