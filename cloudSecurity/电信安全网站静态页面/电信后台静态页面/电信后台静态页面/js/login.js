...
window.onload =function(){
	...
	$('#get_email_yzm').click(function(){
		...
		$('.yzfs').text('验证邮箱');
		$('#regist_phone').remove();
		$('#yzbox').append('<input type="text" class="regist_txt required email" name="email" id="regist_email"/>');
	});
	//切换手机验证
	$('#get_phone_yzm').click(function(){
		...
		$('.yzfs').text('验证手机');
		$('#regist_email').remove();
		$('#yzbox').append('<input type="text" class="regist_txt required" name="phone" id="regist_phone"/>');
	});
	//增加新规则
